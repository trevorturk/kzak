...
#   # ===
#     
#   test "should create an post via (real) url" do
#     u = Post.create!(:attachment_url => 'http://www.google.com/intl/en_ALL/images/logo.gif')
...
#   end
#   
#   test "should require post provided via (real) url to be valid" do
#     assert_no_difference 'Post.count' do
#       u = Post.create(:attachment_url => 'invalid')
